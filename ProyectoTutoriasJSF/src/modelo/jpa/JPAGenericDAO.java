...
public class JPAGenericDAO<T, ID> implements GenericDAO<T, ID> {
	...
	public JPAGenericDAO(Class<T> persistentClass) {
		...
		this.em = Persistence.createEntityManagerFactory("JPATutorias").createEntityManager();
	}
	...
	/**
	 * @author macintosh
	 * @return Lista de Usuarios basado en parametros
	 * @see Pagina 28 y 29 de Diapositiva 4.- Persistencia.
	 * @param attributes Lista (String) de campos sobre los cuales se va a realizar la busqueda
	 * @param values Lista (String) de valores que pueden tomar los campos de attributes
	 * @param order Nombre del Campo por el cual se realizará el ordenamiento. Este siempre es Ascendente
	 * @param index Numero de indice de fila para presentar ( paginacion)
	 * @param size Numero de filas que se deben presentar (paginacion). Si pones -1 o 0 no se tiene paginacion.
	 */
